<script lang="ts">
  ...
  import { DarkMode, Navbar, NavBrand, NavLi, NavUl, NavHamburger, Sidebar, SidebarBrand, SidebarGroup, SidebarItem, SidebarWrapper, Drawer, CloseButton, SidebarDropdownWrapper, Button, SidebarDropdownItem } from 'flowbite-svelte';
	import { Cog, Home, Newspaper, Envelope, ChatBubbleOvalLeftEllipsis } from 'svelte-heros-v2'
  ...
  let myicon= 'Envelope'
  const icons = { about: Envelope, contact: ChatBubbleOvalLeftEllipsis}
</script>

<svelte:window bind:innerWidth={width} />

<Navbar let:hidden let:toggle>
 <NavHamburger on:click={toggleDrawer} btnClass="ml-3 lg:hidden" />  <NavBrand href="/">
    <Cog />
